...
Route::get(
    'konfirmasi/{email}/{register_token}',
    'Auth\RegisterController@konfirmasipendaftaran'
)->name('konfirmasi');

Route::get('sitemap', function () {
    SitemapGenerator::create('http://127.0.0.1:8000')
        ->maxTagsPerSitemap(20)
...
Route::group(['middleware' => ['auth', 'checkRole:admin']], function () {
    ...
    //import Produk
    Route::get('/products/import', 'admin\ProdukController@import')->name('produk_import');
    Route::post('/produk/import-xlxs', 'admin\ImportController@importExcel');
    //import Produk
    Route::get('/kategori/import', 'admin\KategoriImport@import')->name('kategori_import');
    Route::post('/kategori/import-xlxs', 'admin\KategoriImport@importExcel');
});
Auth::routes(['verify' => true]);
